...
const Team = () => {
  return (
    ...
    <div className='team-card'>
        ...
        <div class="card-title fs-5 text-center">Siddharth <span className='poojary'>Poojary</span></div>
        <div class="card-subtitle">Frontend Developer</div>
        </div>
...
<div className='team-card'>
        ...
        <div class="card-info">
        <div class="card-avatar"></div>
        <div class="card-title fs-5">Rahul Pote</div>
        <div class="card-subtitle">Backend Developer</div>
        </div>
        <ul class="card-social">
        <li class="card-social__item">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div className='team-card'>
        ...
        <div class="card-info">
        <div class="card-avatar"></div>
        <div class="card-title fs-5">Manthan Shah</div>
        <div class="card-subtitle">Developer Team</div>
        </div>
        <ul class="card-social">
        <li class="card-social__item">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div className='team-card'>
        ...
        <div class="card-info">
        <div class="card-avatar"></div>
        <div class="card-title fs-5">Rahul Shah</div>
        <div class="card-subtitle">Product Manager</div>
        </div>
        <ul class="card-social">
        <li class="card-social__item">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
